...
private slots:
    ...
    void on_forestVisualizationEyeXSlider_2_valueChanged(int value);

    void on_forestVisualizationEyeYSlider_2_valueChanged(int value);

    void on_forestVisualizationEyeZSlider_2_valueChanged(int value);

    void on_forestVisualizationEyeRSlider_2_valueChanged(int value);

    void on_visualizationTemperatureRangeSlider_2_valuesChanged(int , int );
private:
