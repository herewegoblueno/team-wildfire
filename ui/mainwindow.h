...
public:
    ...
    void createWindForNonCuda(float y, float x);
...
private slots:
    ...
    void on_fireVisualizationEyeYSlider_valueChanged(int value);

    void on_fireVisualizationEyeXSlider_valueChanged(int value);

    void on_fireVisualizationEyeZSlider_valueChanged(int value);

    void on_fireVisualizationEyeRSlider_valueChanged(int value);

    void on_fireVisualizationTemperatureRangeSlider_valuesChanged(int , int );

    void on_RenderSmokeForest_stateChanged(int arg1);
...
private:
    ...
    double dividerForWindSliders = 100.0;
};
